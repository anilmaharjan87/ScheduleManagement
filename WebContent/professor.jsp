    ...
    <section class=sm-padding bg-dark" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-6">
            <form action="ProfessorServlet" class="bg-white rounded pb_form_v1" method="post">
              <h2 class="mb-4 mt-0 text-center">Professor Detail</h2>
              <div class="form-group">
                Professor Name<input type="text" class="form-control pb_height-50 reverse" placeholder="Enter the Professor Name" name="professorName">
              </div>
