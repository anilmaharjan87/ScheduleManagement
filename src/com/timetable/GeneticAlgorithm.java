...
public class GeneticAlgorithm {
	...
	// extra termination condition to assure 0 clashes added by dipu
	public boolean isTerminationConditionMet(Timetable timetable){
		if(timetable.calcClashes()==0)
			return true;
		return false;
	...
	public double calcFitness(Individual individual, Timetable timetable) {
		...
		// Create new com.timetable object to use -- cloned from an existing com.timetable
