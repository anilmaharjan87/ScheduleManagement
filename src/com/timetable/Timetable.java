...
/**
 * Timetable is the main evaluation class for the class scheduler GA.aq
 * 
 * A com.timetable represents a potential solution in human-readable form, unlike an
 * Individual or a chromosome. This com.timetable class, then, can read a chromosome
 * and develop a com.timetable from it, and ultimately can evaluate the com.timetable
...
public class Timetable {
	...
	/**
	 * "Clone" a com.timetable. We use this before evaluating a com.timetable so we have
	 ...
	 * @param professorIds
	 */
	public void addSubject(int subjectId, String subjectCode, String subject, int professorIds[]) {
		this.subjects.put(subjectId, new Subject(subjectId, subjectCode, subject, professorIds));
	}
	...
	public void createClasses(Individual individual) {
		...
		for (Group group : this.getGroupsAsArray()) {
			...
			for (int subjectId : subjectIds) {
				classes[classIndex] = new Class(classIndex, group.getGroupId(), subjectId);
	...
	public Subject getModule(int moduleId) {
		return (Subject) this.subjects.get(moduleId);
	}
	 ...
	 * chromosome.
	 * 
	 * The most important method in this class; look at a candidate com.timetable
